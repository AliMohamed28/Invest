...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; border: groove; text-align: left">
            <h3 id="headingtext" runat="server" style="text-align:center">Stochastic Oscillator</h3>
            <table>
                <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: 100%; height: 100%">
            <ContentTemplate>
                <asp:Chart ID="chartSTOCH" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid" EnableViewState="True"
                    OnClick="chartSTOCH_Click" ImageType="Png">
                    ...
                    <Legends>
                        <asp:Legend Name="legendSTOCH" LegendItemOrder="SameAsSeriesOrder" Docking="Top" Alignment="Center" LegendStyle="Row" BorderDashStyle="Dash" BorderColor="Black"></asp:Legend>
                    </Legends>
                    <Series>
                        <asp:Series Name="seriesSlowK" Legend="legendSTOCH" LegendText="SlowK" ChartType="Line" ChartArea="chartareaSlowK" PostBackValue="0, #VALX, #VALY" ToolTip="SlowK: Date:#VALX;   Value:#VALY"></asp:Series>
                    </Series>
                    <Series>
                        <asp:Series Name="seriesSlowD" Legend="legendSTOCH" LegendText="SlowD" ChartType="Line" ChartArea="chartareaSlowD" PostBackValue="1, #VALX, #VALY" ToolTip="SlowD: Date:#VALX;   Value:#VALY"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="chartareaSlowK" AlignmentOrientation="Vertical"></asp:ChartArea>
                        <asp:ChartArea  Name="chartareaSlowD" AlignmentOrientation="Vertical"></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
