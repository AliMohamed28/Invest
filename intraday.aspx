...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; border: groove; text-align: left">
            <h3 id="headingtext" runat="server" style="text-align:center">Intra-day</h3>
            <table>
                <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: 100%; height: 100%">
            <ContentTemplate>
                <asp:Chart ID="chartintraGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid">
                    <Legends>
                        <asp:Legend Name="legendIntra" LegendItemOrder="SameAsSeriesOrder" Docking="Top" Alignment="Center" LegendStyle="Row" BorderDashStyle="Dash" BorderColor="Black"></asp:Legend>
                    </Legends>
                    <Series>
                        <asp:Series Name="Open" YAxisType="Primary" ChartType="Line" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="Open" ToolTip="Open: Date:#VALX{g}; Value:#VALY"></asp:Series>
                        <asp:Series Name="High" YAxisType="Primary" ChartType="Line" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="High" ToolTip="High: Date:#VALX{g}; Value:#VALY"></asp:Series>
                        <asp:Series Name="Low" YAxisType="Primary" ChartType="Line" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="Low" ToolTip="Low: Date:#VALX{g}; Value:#VALY"></asp:Series>
                        <asp:Series Name="Close" YAxisType="Primary" ChartType="Line" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="Close" ToolTip="Close: Date:#VALX{g}; Value:#VALY"></asp:Series>
                        <asp:Series Name="OHLC" YAxisType="Primary" ChartType="Candlestick" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="OHLC" ToolTip="Date:#VALX{g}; Open:#VALY1; High:#VALY2; Low:#VALY3; Close:#VALY4"></asp:Series>
                        <asp:Series Name="Volume" YAxisType="Secondary" ChartType="Column" ChartArea="chartareaIntra" Legend="legendIntra" LegendText="Volume" ToolTip="Volume: Date:#VALX{g}; Value:#VALY"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="chartareaIntra"></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
                <div></div>
