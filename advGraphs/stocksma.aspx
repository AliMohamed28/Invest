<%@ Page Title="" Language="C#" MasterPageFile="~/advGraphs/advancegraphs.Master" AutoEventWireup="true" CodeBehind="stocksma.aspx.cs" Inherits="Analytics.advGraphs.stocksma" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
    <asp:Chart ID="chartAdvGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="SMA_SMALL" Enabled="false" XAxisType="Secondary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea1" Legend="legendAdvGraph" 
                LegendText="SMA Small"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="SMA_SMALL" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; SMA Small Value:#VALY{0.##}">
            </asp:Series>

            <asp:Series Name="SMA_LONG" Enabled="false" XAxisType="Secondary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea1" Legend="legendAdvGraph" 
                LegendText="SMA Long"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="SMA_LONG" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; SMA Long Value:#VALY{0.##}">
            </asp:Series>
        ...
        <ChartAreas>
            <asp:ChartArea Name="chartarea1" AlignmentOrientation="Vertical" AlignmentStyle="PlotPosition">
                ...
                <AxisY Title="Daily Price Vs SMA Fast Vs SMA Slow" TitleAlignment="Center" IsMarginVisible="false" IsLabelAutoFit="true" LabelAutoFitStyle="DecreaseFont"
                ...
                <td style="width: 100%; text-align: center;">
                    <asp:GridView ID="GridViewData" Enabled="false" Visible="false" runat="server" Width="100%" Height="50%" AutoGenerateColumns="False" HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="SMA Fast" DataField="SMA_SMALL" ItemStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="SMA Slow" DataField="SMA_LONG" ItemStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
