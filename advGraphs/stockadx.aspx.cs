...
{
    public partial class stockadx : System.Web.UI.Page
    {
        ...
        public void ShowADX()
        {
            ...
            try
            {
                ...
                if (chartAdvGraph.Series.FindByName("ADX") != null)
                {
                    ...
                    chartAdvGraph.Series["ADX"].PostBackValue = "ADX," + symbol + "," + "#VALX,#VALY";
                }
            }
            catch (Exception ex)
            {
        ...
        public void buttonShowSelectedIndicatorGraph_Click()
        {
            ...
            for (int i = 0; i < Master.dropdownGraphList.Items.Count; i++)
            {
                ...
                {
                    if (Master.dropdownGraphList.Items[i].Value.Equals("ADX"))
                    {
                        bArea1 = true;
                    }
