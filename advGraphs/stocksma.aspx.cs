...
{
    public partial class stocksma : System.Web.UI.Page
    {
        ...
        public void fillGraphList()
        {
            ...
            Master.dropdownGraphList.Items.Add(li);
            li = new ListItem("SMA Fast", "SMA_SMALL");
            Master.dropdownGraphList.Items.Add(li);

            li = new ListItem("SMA Slow", "SMA_LONG");
            Master.dropdownGraphList.Items.Add(li);
        ...
        public void ShowSMA()
        {
            ...
            try
            {
                ...
                if ((smallperiod.Equals(string.Empty) == false) && (Int32.Parse(smallperiod) > 0))
                {
                    ...
                    chartAdvGraph.Series["SMA_SMALL"].PostBackValue = "SMA Fast," + symbol +"." + exchange + "," + "#VALX,#VALY{0.##}";
                    chartAdvGraph.Series["SMA_SMALL"].Enabled = true;
                }
                if ((longperiod.Equals(string.Empty) == false) && (Int32.Parse(longperiod) > 0))
                {
                    ...
                    chartAdvGraph.Series["SMA_LONG"].PostBackValue = "SMA Slow," + symbol + "," + "#VALX,#VALY{0.##}";
                    chartAdvGraph.Series["SMA_LONG"].Enabled = true;
                }
            }
            catch (Exception ex)
            {
