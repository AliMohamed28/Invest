<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="meditscript.aspx.cs" Inherits="Analytics.meditscript" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%; border: solid; border-width: 1px; border-color: black;margin-top:1%;">
        ...
        <tr>
            ...
            <td style="width: 20%;">
                <asp:TextBox ID="textboxPurchaseDate" runat="server" TextMode="Date" AutoPostBack="true" OnTextChanged="textboxPurchaseDate_TextChanged" ToolTip="Enter date of purchase" TabIndex="3"></asp:TextBox>
            </td>
            <td style="width: 20%;"></td>
        </tr>
        <tr>
