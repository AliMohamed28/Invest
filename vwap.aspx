<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vwap.aspx.cs" Inherits="Analytics.vwap" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; border: groove; text-align: left">
            <h3 id="headingtext" runat="server" style="text-align:center">Volume weighted average price</h3>
            <table>
                <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: 100%; height: 100%">
            <ContentTemplate>
                <asp:Chart ID="chartVWAP" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid" 
                    ...
                    <Series>
                        <asp:Series Name="seriesVWAP" ChartType="Line" ChartArea="chartareaVWAP" PostBackValue="#VALX, #VALY" ToolTip="Date:#VALX{g}; Value:#VALY"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="chartareaVWAP" AlignmentOrientation="Vertical"></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
