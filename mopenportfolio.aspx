            ...
            <div class="table-responsive">
                <div class="container table-responsive" style="width=100%; padding-top: 1%; text-align: center; position: fixed; background-color: #c2c2c2;">
                    ...
                    <div style="width=100%; padding-top: 2px; padding-bottom: 2px;">
                        ...
                        <asp:Label ID="lblCompName" CssClass="text-left" runat="server" Text="" ForeColor="Black" Font-Bold="false"></asp:Label>
                        <br />
                        ...
                        <asp:Label ID="lblScript" CssClass="text-left" runat="server" Text="" ForeColor="Black" Font-Bold="false"></asp:Label>
                        ...
                        <asp:Label ID="lblExchange" CssClass="text-left" runat="server" Text="" ForeColor="Black" Font-Bold="false"></asp:Label>
                        <br />
                        <asp:Label ID="Label7" CssClass="text-right" runat="server" Text="Investment Type:" ForeColor="Black" Font-Bold="true"></asp:Label>
                        <asp:Label ID="lblInvestmentType" CssClass="text-left" runat="server" Text="" ForeColor="Black" Font-Bold="false"></asp:Label>
