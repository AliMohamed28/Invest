...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        window.addEventListener("beforeunload", function (e) {
            sessionStorage.setItem('mfportscrollpos', "-1");
        });
    ...
    <div style="text-align:center; padding: 10% 5% 10% 5%; border: solid"">
        ...
        <asp:DropDownList ID="ddlPortfolios" runat="server" AutoPostBack="True" OnSelectedIndexChanged="buttonLoad_Click"></asp:DropDownList>
        <br />
        <br />
                        ...
                        <tr style="width: 100%;">
                            <td style="width: 100%; text-align: center; margin-top: 2px;">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>--%>
                                <asp:Label ID="lblDashboard" runat="server" Font-Bold="true" Font-Size="Medium" Text="MF Portfolio Manager for: "></asp:Label>
                                <%--</ContentTemplate>
                                </asp:UpdatePanel>--%>
                            </td>
                        </tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action" Visible="true" ShowHeader="true">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnBarGraph" runat="server" OnClick="btnBarGraph_Click" class="btn btn-primary btn-sm" Text="Cost Vs Value&raquo;"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
