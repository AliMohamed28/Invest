...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; border: groove; text-align: left">
            <h3 id="headingtext" runat="server" style="text-align:center">Relative strength index</h3>
            <table>
                <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: 100%; height: 100%">
            <ContentTemplate>
                <asp:Chart ID="chartRSI" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid" EnableViewState="True"
                    OnClick="chartRSI_Click" ImageType="Png">
                    ...
                    <Series>
                        <asp:Series Name="seriesRSI" ChartType="Line" ChartArea="chartareaRSI" PostBackValue="#VALX, #VALY" ToolTip = "RSI: Date:#VALX; Value:#VALY"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="chartareaRSI" AlignmentOrientation="Vertical"></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
