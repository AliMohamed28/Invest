...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; border: groove; text-align: left">
            <h3 id="headingtext" runat="server" style="text-align:center">AROON</h3>
            <table>
                <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="width: 100%; height: 100%">
            <ContentTemplate>
                <asp:Chart ID="chartAROON" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid" EnableViewState="True"
                    OnClick="chartAROON_Click" ImageType="Png">
                    ...
                    <Legends>
                        <asp:Legend Name="legendAROON" LegendItemOrder="SameAsSeriesOrder" Docking="Top" Alignment="Center" LegendStyle="Row" BorderDashStyle="Dash" BorderColor="Black"></asp:Legend>
                    </Legends>
                    <Series>
                        <asp:Series Name="seriesAROON_Down" Legend="legendAROON" LegendText="AROON Down" ChartType="Line" ChartArea="chartareaAROON" PostBackValue="#VALX, #VALY" ToolTip="AROON Down: Date:#VALX;   Value:#VALY"></asp:Series>
                    </Series>
                    <Series>
                        <asp:Series Name="seriesAROON_Up" Legend="legendAROON" LegendText="AROON Up" ChartType="Line" ChartArea="chartareaAROON" PostBackValue="#VALX, #VALY" ToolTip = "AROON Up: Date:#VALX;   Value:#VALY"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="chartareaAROON" AlignmentOrientation="Vertical"></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
